...
module.exports = Texy_Html = (function() {
  ...
  Texy_Html.prototype.toString = function(texy) {
    var child, ct, s, _i, _len, _ref;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      child = _ref[_i];
      s += _.isObject(child) ? child.toString(texy) : child;
    }
    return s += texy.protect(this.endTag(), ct);
  };

  Texy_Html.prototype.toHtml = function(texy) {
    return texy.stringToHtml(this.toString(texy));
  };

  Texy_Html.prototype.toText = function(texy) {
